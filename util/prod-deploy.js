...
(function () {
   ...
   inquirer.prompt(questions).then(answers => {
      var url = `https://${answers.username}:${answers.password}@${answers.domain}/rest-api/1/0/${queryString.escape(props.siteName)}/Addon%20Repository/${answers.addonName}/webAppImport`,
